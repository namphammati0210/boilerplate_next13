...
import avtar from "../../public/images/team-2.jpg";
...
const menu = (
  <List
    ...
    renderItem={(item) => (
      <List.Item>
        <List.Item.Meta
          // avatar={<Avatar shape="square" src={<Image src={item.avatar} />} />}
          title={item.title}
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
          <div className="ant-page-header-heading">
            <span
              className="ant-page-header-heading-title uppercase"
              style={{ color: "black" }}
            >
              Dashboard
            </span>
        ...
        <Col span={24} md={18} className="header-control">
          ...
          <Button
            type="link"
            className="sidebar-toggler bg-slate-900"
